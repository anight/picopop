 ...
 *
 * Written for picosdl's demo, and kept here after the demo stopped needing it: its
 * music is original now and it links no game code at all. These tests still render
 * Prince of Persia's tunes through SDLPoP's midi.c on the host, which is what the
 * glue below exists for.
 *
